...
namespace Plugin_ChitietNTTuoiMia_TuoiMia
{
    public class Plugin_ChitietNTTuoiMia_TuoiMia : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (target.Contains("new_thuadat") && context.Depth < 2 && target["new_thuadat"] != null )
            {
                ...
                linkEntity1.LinkCriteria.AddCondition(new ConditionExpression("new_thuadat", ConditionOperator.Equal, ((EntityReference)chitietnghiemthutuoimia["new_thuadat"]).Id));
