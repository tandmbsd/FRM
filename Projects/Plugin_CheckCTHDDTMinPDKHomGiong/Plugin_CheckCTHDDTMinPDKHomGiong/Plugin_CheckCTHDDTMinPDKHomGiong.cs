...
namespace Plugin_CheckCTHDDTMinPDKHomGiong
{
    public class Plugin_CheckCTHDDTMinPDKHomGiong : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.MessageName.ToLower().Trim() == "associate")
            {
                ...
                if (((EntityReference)thuadatcanhtac["new_hopdongdautumia"]).Id != ((EntityReference)pdkhomgiong["new_hopdongdautumia"]).Id)
                {
