...
{
    public sealed class Plugin_ThemCSDTvaoNTTuoiMiaUpdate : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && (context.InputParameters["Target"] is Entity))
            {
                ...
                if (ChiTietNTTuoiMiaTuoiMia.LogicalName == "new_chitietnghiemthutuoimia_tuoimia")
                {
                    ...
                    if (context.MessageName.ToUpper() == "UPDATE" && context.Depth < 2)
                    {
                        ...
                        else
                        {
                            ...
                            if (ChiTietNTTuoiMiaTuoiMia.Contains("new_chitietnghiemthutuoimia")) // new_chitietnghiemthutuoimia
                            {
