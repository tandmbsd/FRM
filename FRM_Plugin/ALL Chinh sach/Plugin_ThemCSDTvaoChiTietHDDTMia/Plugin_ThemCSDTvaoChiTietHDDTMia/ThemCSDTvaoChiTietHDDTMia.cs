...
{
    public sealed class ThemCSDTvaoChiTietHDDTMia : IPlugin
    {
                            ...
                            else
                            {
                                ...
                                if (mCSDT != null && mCSDT.Id != Guid.Empty)
                                {
                                  ...
                                  <entity name='new_thongsotheovudautu'>
                                    ...
                                    decimal dientichhd = dientichhd = (ChiTietHD.Contains("new_dientichhopdong") ? (decimal)ChiTietHD["new_dientichhopdong"] : 0);
                                ...
                                //else
                                //{
                                //    if (ChiTietHD.Contains("new_copytuhddtthuedat") && (bool)ChiTietHD["new_copytuhddtthuedat"] == true)
                                //    { }
                                //    else
