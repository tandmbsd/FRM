        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && (context.InputParameters["Target"] is Entity))
            {
                ...
                if (ChiTietHDDTTrangThietBi.LogicalName == "new_hopdongdaututrangthietbichitiet")
                {
                    ...
                    {
                        ChiTietHDDTTrangThietBi = service.Retrieve("new_hopdongdaututrangthietbichitiet", entityId, new ColumnSet(new string[] { "new_maymocthietbi", "createdon", "new_name", "new_giatrihopdong", "new_hopdongdaututrangthietbi", "new_giatrithietbi" , "new_chinhsachdautu"}));
