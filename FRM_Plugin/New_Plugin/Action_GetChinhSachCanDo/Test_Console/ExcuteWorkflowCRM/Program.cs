    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (OrganizationServiceProxy serviceProxy = new OrganizationServiceProxy(OrganizationUri, HomeRealmUri, credentials, null))
            {
                ...
                try
                {
                    Guid LenhdonId = Guid.Parse("FF3CCEA1-CCA7-E611-80C9-9457A558474F");
                    Guid VuDauTuId = Guid.Parse("cdc1f2d0-4e07-e611-80c0-9abe942a7cb1");
                    decimal tapchatthanhtoan = decimal.Parse("2.07");
                    decimal ccsThanhtoan = decimal.Parse("8.65");
                    ...
                    else
                    {
                        ...
                        if (LenhDon.Contains("h.new_chitietbbthuhoachsomid") && (bool)((AliasedValue)LenhDon["h.new_baohiemccs"]).Value && (DateTime)LenhDon["new_ngaycap"] <= (DateTime)((AliasedValue)LenhDon["h.new_ngayhethan"]).Value && !(bool)LenhDon["new_miadutuoi"])
                        {
