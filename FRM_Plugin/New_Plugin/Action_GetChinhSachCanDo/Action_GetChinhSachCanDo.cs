        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (ccsThanhtoan>0 && LenhDon.Contains("h.new_chitietbbthuhoachsomid") && (bool)((AliasedValue)LenhDon["h.new_baohiemccs"]).Value && (DateTime)LenhDon["new_ngaycap"] <= (DateTime)((AliasedValue)LenhDon["h.new_ngayhethan"]).Value && !(bool)LenhDon["new_miadutuoi"])
                    {
