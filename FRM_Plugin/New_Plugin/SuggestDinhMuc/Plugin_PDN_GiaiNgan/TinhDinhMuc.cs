...
namespace Plugin_PDN_GiaiNgan
{
    public class TinhDinhMuc
    {
        ...
        {
            Entity PDNGN = service.Retrieve("new_phieudenghigiaingan", ((EntityReference)pdk["new_phieudenghigiaingan"]).Id, new ColumnSet(true));
            ...
            if (((OptionSetValue)PDNGN["new_loaihopdong"]).Value == 100000000) //HD mía
            {
                ...
                else
                {
                    ...
                    else if (((OptionSetValue)pdk["new_loainghiemthu"]).Value == 100000003) //NT đầu tư bổ sung vốn
                    {
                    ...
                    else if (((OptionSetValue)pdk["new_loainghiemthu"]).Value == 100000004) //NT khác
                    {
                        #region NT Khac
                    ...
                    else if (((OptionSetValue)pdk["new_loainghiemthu"]).Value == 100000005) //Tạm ứng
                    {
                        #region Tạm Ứng    
            ...
            else if (((OptionSetValue)PDNGN["new_loaihopdong"]).Value == 100000002) // HD MMTB
            {
                ...
                Entity NT = service.Retrieve("new_nghiemthumaymocthietbi", ((EntityReference)pdk["new_nghiemthummtb"]).Id, new ColumnSet(true));
