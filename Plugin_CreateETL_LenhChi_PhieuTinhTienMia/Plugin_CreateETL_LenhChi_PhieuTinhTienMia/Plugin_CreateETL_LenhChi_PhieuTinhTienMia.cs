...
namespace Plugin_CreateETL_LenhChi_PhieuTinhTienMia
{
    public class Plugin_CreateETL_LenhChi_PhieuTinhTienMia : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (target.Contains("statuscode") && ((OptionSetValue)target["statuscode"]).Value == 100000000) // da duyet
            {
                ...
                while (true)
                {
                    ...
                    {
                        var lenhDon = service.Retrieve("new_lenhdon", ((EntityReference)phieuTTMia["new_lenhdon"]).Id, new ColumnSet(new string[] { "new_hopdongvanchuyen" }));
                        ...
                        {
                            var tienMia = ((Money)phieuTTMia["new_chiphinhamaymuamia"]).Value - tamGiuNongDan - ((Money)phieuTTMia["new_tienchichumia"]).Value;
                            ...
                            if (tienMia > 0)
                            {
                                ...
                                etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_CHIPHIMUAMIA_" + "_STA" + test;//Lenh chi, vu thu hoach, 
                                    ...
                                    if (dsPhieuTinhLai != null && dsPhieuTinhLai.Entities.Count > 0)
                                    {
                                        ...
                                        foreach (var phieuTinhLai in dsPhieuTinhLai.Entities)
                                        {
                                            ...
                                            if (phanBoDauTu.Contains("new_etltransaction"))
                                            {
                                                ...
                                                if (etlTransaction.Contains("new_invoicetype")
                                                    && (etlTransaction["new_invoicetype"].ToString() == "PRE" || etlTransaction["new_invoicetype"].ToString() == "CRE")
                                                    && (phieuTinhLai.Contains("new_tienvay") && ((Money)phieuTinhLai["new_tienvay"]).Value > 0))
                                                {
                                                    if (etlTransaction["new_invoicetype"].ToString() == "CRE")
                                                    {
                                                        ...
                                                        apply_CanTruTienNoGoc["new_paymentdate"] = fullEntity["new_ngayduyet"];
                                                    ...
                                                    apply_PhaiTraCanTruPRE["new_paymentdate"] = fullEntity["new_ngayduyet"];
                                            ...
                                            if (phieuTinhLai.Contains("new_tienlai") && ((Money)phieuTinhLai["new_tienlai"]).Value > 0)
                                            {
                                                ...
                                                etl_ND["new_name"] = phieuDNThuNo["new_masophieu"].ToString() + "_" + i.ToString() + "_CRE" + "_" + test;
                                                ...
                                                apply_PhaiTraCanTruCRE["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuDNThuNo["new_ngaythu"];
                                                ...
                                                apply_CanTruTienNoGoc["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuDNThuNo["new_ngaythu"];
                                                apply_CanTruTienNoGoc["new_paymentdocumentname"] = "CANTRU_03";
                                                apply_CanTruTienNoGoc["new_vouchernumber"] = "CTND";
                                                apply_CanTruTienNoGoc["new_cashflow"] = "00.00";
                                                apply_CanTruTienNoGoc["new_paymentnum"] = "1";
                            ...
                            if (phieuTTMia.Contains("new_tienchichumia") && ((Money)phieuTTMia["new_tienchichumia"]).Value > 0)
                            {
                                ...
                                etl_STAChiChuMia["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_MIA_" + "_STA" + test;//Lenh chi, vu thu hoach, 
                                ...
                                if (khNongDan.Contains("new_phuongthucthanhtoan") && ((OptionSetValue)khNongDan["new_phuongthucthanhtoan"]).Value == 100000001)
                                {
                                    ...
                                    apply_STAMia["new_paymentdate"] = fullEntity["new_ngayduyet"];// phieuTTMia["new_ngaylap"];
                        ...
                        if (phieuTTMia.Contains("new_tienxe") && phieuTTMia.Contains("new_hopdongvanchuyen") && ((Money)phieuTTMia["new_tienxe"]).Value > 0 && lenhDon.Contains("new_hopdongvanchuyen"))
                        {
                            ...
                            if (((Money)phieuTTMia["new_tienxe"]).Value - tienChiVanChuyen - tamGiuVanChuyen > 0)
                            {
                                #region STA Van chuyen
                                // STA
                                Entity etl_STA = new Entity("new_etltransaction");
                                etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_VC_" + "_STA" + test;
                                etl_STA["new_vouchernumber"] = "MMND";
                                ...
                                etl_STA["new_terms"] = "Tra Ngay";
                                etl_STA["new_taxtype"] = "";
                                etl_STA["new_invoiceamount"] = new Money(((Money)phieuTTMia["new_tienxe"]).Value - tienChiVanChuyen - tamGiuVanChuyen);
                                etl_STA["new_gldate"] = fullEntity["new_ngayduyet"];
                                etl_STA["new_invoicetype"] = "STA";
                                    ...
                                    if (dsPhieuTinhLai != null && dsPhieuTinhLai.Entities.Count > 0)
                                    {
                                        ...
                                        foreach (var phieuTinhLai in dsPhieuTinhLai.Entities)
                                        {
                                            ...
                                            if (phanBoDauTu.Contains("new_etltransaction"))
                                            {
                                                    ...
                                                    && (phieuTinhLai.Contains("new_tienvay") && ((Money)phieuTinhLai["new_tienvay"]).Value > 0))
                                                {
                                                    if (etlTransaction.Contains("new_invoicetype") && (etlTransaction["new_invoicetype"].ToString() == "PRE" || etlTransaction["new_invoicetype"].ToString() == "CRE"))
                                                    {
                                                        ...
                                                        apply_PhaiTraCanTruPRE["new_referencenumber"] = phieuDNThuNo["new_masophieu"] + "_" + i.ToString();
                                                        apply_PhaiTraCanTruPRE["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuDNThuNo["new_ngaythu"];
                                                        apply_PhaiTraCanTruPRE["new_paymentdocumentname"] = "CANTRU_04";
                                                        apply_PhaiTraCanTruPRE["new_vouchernumber"] = "CTND";
                                                        apply_PhaiTraCanTruPRE["new_cashflow"] = "00.00";
                                                        apply_PhaiTraCanTruPRE["new_paymentnum"] = "1";
                                            ...
                                            if (phieuTinhLai.Contains("new_tienlai") && ((Money)phieuTinhLai["new_tienlai"]).Value > 0)
                                            {
                                                #region phat sinh Etl CRE
                                                Entity etl_ND = new Entity("new_etltransaction");
                                                etl_ND["new_name"] = phieuDNThuNo["new_masophieu"].ToString() + "_" + i.ToString() + "_CRE" + test;
                                                etl_ND["new_vouchernumber"] = "DTND";
                                                etl_ND["new_transactiontype"] = "5.4.2.b";
                                                etl_ND["new_customertype"] = new OptionSetValue(1);
                                                etl_ND["new_season"] = vuMua;
                            ...
                            if (tienChiVanChuyen > 0)
                            {
                                ...
                                etl_STAChiVanChuyen["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_CHI_VC_" + "_STA" + test;
                                ...
                                if (khVanChuyen.Contains("new_phuongthucthanhtoan") && ((OptionSetValue)khVanChuyen["new_phuongthucthanhtoan"]).Value == 100000001)
                                {
                                    ...
                                    apply_STAVC["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuTTMia["new_ngaylap"];
                            ...
                            apply_STACanTruTHVC["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuTTMia["new_ngaylap"];
                            ...
                            etl_CRE["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_THUHO_VC_" + "_CRE" + test;
                            ...
                            apply_CREVC["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuTTMia["new_ngaylap"];
                            ...
                            apply_CREVC["new_makhachhang"] = khNongDan.Contains("new_makhachhang") ? khNongDan["new_makhachhang"].ToString() : "";
                            apply_CREVC["name"] = (khNongDan.LogicalName.ToLower() == "contact" ? (khNongDan.Contains("fullname") ? khNongDan["fullname"].ToString() : "") : (khNongDan.Contains("name") ? khNongDan["name"].ToString() : ""));
                            apply_CREVC["new_socmnd"] = (khNongDan.LogicalName.ToLower() == "contact" ? (khNongDan.Contains("new_socmnd") ? khNongDan["new_socmnd"].ToString() : "") : (khNongDan.Contains("new_masothue") ? khNongDan["new_masothue"].ToString() : ""));
                        ...
                        if (phieuTTMia.Contains("new_tiencongdon") && phieuTTMia.Contains("new_hopdongthuhoach") && ((Money)phieuTTMia["new_tiencongdon"]).Value > 0)
                        {
                            ...
                            if (((Money)phieuTTMia["new_tiencongdon"]).Value - tienChiDauCong - tamGiuThuHoach > 0)
                            {
                                // STA
                                Entity etl_STA = new Entity("new_etltransaction");
                                etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_CD_" + "_STA" + test;
                                etl_STA["new_vouchernumber"] = "MMND";
                                ...
                                etl_STA["new_terms"] = "Tra Ngay";
                                etl_STA["new_taxtype"] = "";
                                etl_STA["new_invoiceamount"] = new Money(((Money)phieuTTMia["new_tiencongdon"]).Value - tamGiuThuHoach - tienChiDauCong);
                                etl_STA["new_gldate"] = fullEntity["new_ngayduyet"];
                                etl_STA["new_invoicetype"] = "STA";
                            ...
                            if (tienChiDauCong > 0)
                            {
                                ...
                                etl_STAChiDauCong["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_CHI_CD_" + "_STA" + test;
                            ...
                            apply_STACanTruTHCD["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuTTMia["new_ngaylap"];
                            ...
                            // CRE                        
                            Entity etl_CRE = new Entity("new_etltransaction");
                            etl_CRE["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_THUHO_CD_" + "_CRE" + test;
                            etl_CRE["new_vouchernumber"] = "MMND";
                            ...
                            apply_CRETH["new_paymentdate"] = fullEntity["new_ngayduyet"];//phieuTTMia["new_ngaylap"];
                        ...
                        if (phieuTTMia.Contains("new_tamgiunongdan") && ((Money)phieuTTMia["new_tamgiunongdan"]).Value > 0)
                        {
                            #region Tam giu nong dan
                            Entity etl_STA = new Entity("new_etltransaction");
                            etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_TAMGIU_ND_" + "_STA" + test;
                            etl_STA["new_vouchernumber"] = "MMND";
                            etl_STA["new_transactiontype"] = "4.3.3.b";
                            etl_STA["new_customertype"] = new OptionSetValue(phieuTTMia.Contains("new_khachhang") ? 1 : 2);
                            etl_STA["new_season"] = vuMua;
                        ...
                        if (phieuTTMia.Contains("new_tamgiuvanchuyen") && phieuTTMia.Contains("new_hopdongvanchuyen") && ((Money)phieuTTMia["new_tamgiuvanchuyen"]).Value > 0)
                        {
                            ...
                            // STA
                            Entity etl_STA = new Entity("new_etltransaction");
                            etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_TAMGIU_VC_" + "_STA" + test;
                            etl_STA["new_vouchernumber"] = "MMND";
                            etl_STA["new_transactiontype"] = "3.3.3.d";
                            etl_STA["new_customertype"] = new OptionSetValue(phieuTTMia.Contains("new_doitacvanchuyen") ? 1 : 2);
                            etl_STA["new_season"] = vuMua;
                        ...
                        if (phieuTTMia.Contains("new_tamgiuthuhoach") && phieuTTMia.Contains("new_hopdongthuhoach") && ((Money)phieuTTMia["new_tamgiuthuhoach"]).Value > 0)
                        {
                            ...
                            // STA
                            Entity etl_STA = new Entity("new_etltransaction");
                            etl_STA["new_name"] = fullEntity["new_masophieu"].ToString() + "_" + phieuTTMia["new_masophieu"].ToString() + "_TAMGIU_CD_" + "_STA" + test;
                            etl_STA["new_vouchernumber"] = "MMND";
                            etl_STA["new_transactiontype"] = "3.3.3.e";
                            etl_STA["new_customertype"] = new OptionSetValue(phieuTTMia.Contains("new_doitacthuhoach") ? 1 : 2);
                            etl_STA["new_season"] = vuMua;
