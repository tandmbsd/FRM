...
namespace Action_Tinhthuongmiachaythap
{
    public class Action_Tinhthuongmiachaythap : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (target.LogicalName == "new_bangkechitiencuoivu")
            {
                ...
                Entity Bangkechitiencuoivu = service.Retrieve(target.LogicalName, target.Id, new ColumnSet(true));
                ...
                if (Bangkechitiencuoivu.Contains("new_vudautu") && Bangkechitiencuoivu.Contains("new_loaibangke"))
                {
                    ...
                    if (dsNTsauTH != null && dsNTsauTH.Entities.Count > 0)
                    {
                        ...
                        if (CSTMcuoivu != null)
                        {
                            ...
                            context.OutputParameters["ReturnId"] = target.Id.ToString();
