...
{
    public sealed class Plugin_ThemCSDTvaoChiTietHDTrangThietBiUpdate : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && (context.InputParameters["Target"] is Entity))
            {
                ...
                if (ChiTietHDDTTrangThietBi.LogicalName == "new_hopdongdaututrangthietbichitiet")
                {
                    ...
                    {
                        ChiTietHDDTTrangThietBi = service.Retrieve("new_hopdongdaututrangthietbichitiet", entityId,
                            new ColumnSet(new string[] { "new_maymocthietbi", "createdon", "new_name", "new_giatrihopdong", "new_hopdongdaututrangthietbi", "new_giatrithietbi", "new_chinhsachdautu" }));
                        ...
                        {
                            EntityReference hddtTTBEntityRef =
                                ChiTietHDDTTrangThietBi.GetAttributeValue<EntityReference>("new_hopdongdaututrangthietbi");
                            ...
                            traceService.Trace("Tim dc CSDT : " + mCSDT["new_name"].ToString());
                            if (mCSDT != null && mCSDT.Id != Guid.Empty)
                            {
                                ...
                                EntityCollection oldlTLTHVDK = FindTLTHVDK(service, ChiTietHDDTTrangThietBi);
                                ...
                                if (csdtKQEntity.Attributes.Contains("new_dinhmucdautuhoanlai"))
                                {
                                    ...
                                    traceService.Trace("Gia tri thiet bi: " + giatrithietbi.ToString());
                                    decimal DMDT = 0;
                                    ...
                                    decimal tu = 0;
                                    decimal den = 0;
                                    traceService.Trace("so luong cs lay duoc: " + dmUngvonDTcol.Entities.Count.ToString());
                                    ...
                                    //traceService.Trace(dmUngvonDT["new_name"].ToString());
                                    ...
                                    if (collTLTHV != null && collTLTHV.Entities.Count > 0)
                                    {
                                        ...
                                        foreach (Entity TLTHV in collTLTHV.Entities)
                                        {
                                            ...
                                            if (TLTHV.Attributes.Contains("new_phantramtilethuhoi") && TLTHV.Attributes.Contains("new_vuthuhoi"))
                                            {
                                                ...
                                                traceService.Trace("lay gia tri hd");
                                                decimal giatrihopdong = (ChiTietHDDTTrangThietBi.Contains("new_giatrihopdong") ? ChiTietHDDTTrangThietBi.GetAttributeValue<Money>("new_giatrihopdong").Value : DMDT);
