...
namespace Plugin_LoadDMvaoPhulucHDGocthanhTo
{
    public class Plugin_LoadDMvaoPhulucHDGocthanhTo : IPlugin
    {
        ...
        void IPlugin.Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && (context.InputParameters["Target"] is Entity))
            {
                ...
                if (PhulucHDGocthanhTo.LogicalName == "new_phuluchopdong_gocsangto")
                {
                    ...
                    {
                        PhulucHDGocthanhTo = service.Retrieve("new_phuluchopdong_gocsangto", entityId,
                            new ColumnSet(new string[] { "new_phuluchopdong", "new_chitiethopdongdautumia", "new_chinhsachdautu",
                                "createdon" , "new_dongiahopdong", "new_dongiahopdongkhl", "new_dongiaphanbonhd" }));
                        ...
                        Entity ChiTietHD = service.Retrieve("new_thuadatcanhtac", ctHDDTmiaRef.Id,
                            new ColumnSet(new string[] { "new_vutrong", "new_loaigocmia", "new_mucdichsanxuatmia", "new_giongmia",
                                "new_thuadat", "createdon", "new_hopdongdautumia", "new_khachhang", "new_khachhangdoanhnghiep",
                                "new_thamgiamohinhkhuyennong", "new_dientichthucte", "new_tuoimia", "new_dientichhopdong",
                                "new_dinhmucphanbontoithieu", "new_chinhsachdautu", "new_copytuhddtthuedat", "new_chinhsachdautu",
                                "new_luugoc" }));
                        ...
                        if (ChiTietHD != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (listCSDTCol != null && listCSDTCol.Entities.Count > 0)
                                {
                                    ...
                                    {
                                        traceService.Trace("chinh sach : " + a["new_machinhsach"].ToString());
                                        ...
                                        traceService.Trace("Pass muc dich san xuat mia");
                                        ...
                                        traceService.Trace("Pass loai so huu dat");
                                        ...
                                        if (dsVungDL.Entities.Count > 0)
                                        {
                                            ...
                                            {
                                                traceService.Trace("thua dat co dia chi ");
                                        ...
                                        traceService.Trace("Pass mo hinh khuyen nong");
                                ...
                                if (mCSDT != null && mCSDT.Id != Guid.Empty)
                                {
                                    ...
                                    Entity csdtKQEntity = service.Retrieve("new_chinhsachdautu", csdtRef.Id,
                                        new ColumnSet(new string[] { "new_dinhmucdautuhoanlai", "new_name", "new_loailaisuatcodinhthaydoi",
                                    ...
                                    traceService.Trace("set chinh sach success");
                                    ...
                                    en["new_dongiadautuhoanlai"] = MdongiaDT;
                                    en["new_dinhmucdautuhoanlai"] = MdinhmucDT;
                                    ...
                                    if (csdtKQEntity.Attributes.Contains("new_dinhmucphanbontoithieu"))   // don gia phan bon toi thieu
                                    {
                                        if (!HDDTmia.Contains("new_chinhantienmat") || (HDDTmia.Contains("new_chinhantienmat") && (bool)HDDTmia["new_chinhantienmat"] == false))
                                        {
                                            ...
                                            en["new_dongiaphanbontoithieu"] = MdongiaPhanbon;
                                            en["new_dinhmucphanbontoithieu"] = MtongDMDTKHL;
                                        }
                                    }
                                    ...
                                    en["new_dinhmucdautu"] = MtongDM;

                                    // --------END--------- DINH MUC DAU TU

                                    // Tính Đầu tư 
                                    decimal dtHL = (PhulucHDGocthanhTo.Contains("new_dongiahopdong") ? ((Money)PhulucHDGocthanhTo["new_dongiahopdong"]).Value : 0) * dientichhd;
                                    decimal dtKHL = (PhulucHDGocthanhTo.Contains("new_dongiahopdongkhl") ? ((Money)PhulucHDGocthanhTo["new_dongiahopdongkhl"]).Value : 0) * dientichhd;
                                    decimal dtPB = (PhulucHDGocthanhTo.Contains("new_dongiaphanbonhd") ? ((Money)PhulucHDGocthanhTo["new_dongiaphanbonhd"]).Value : 0) * dientichhd;
                                    decimal tongtienDT = dtHL + dtKHL + dtPB;

                                    en["new_dautuhoanlai"] = new Money(dtHL);
                                    en["new_dautukhonghoanlai"] = new Money(dtKHL);
                                    en["new_sotienphanbontoithieu"] = new Money(dtPB);
                                    en["new_tongchiphidautu"] = new Money(tongtienDT);
                                ...
                                {
                                    throw new Exception("Không tìm thấy chính sách đầu tư phù hợp");
                                }
                            }
                        } // if(ctHDDTmia != null)
        ...
        {
            Entity HD = crmservices.Retrieve("new_hopdongdautumia", ((EntityReference)ctHDDT["new_hopdongdautumia"]).Id,
                new ColumnSet(new string[] { "new_vudautu" }));

            Entity VDT = crmservices.Retrieve("new_vudautu", ((EntityReference)HD["new_vudautu"]).Id,
