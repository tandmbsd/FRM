...
function btn_DanhGiaPhanNhomKH() {
    debugger;
    $ui.Confirm("Question", "Bạn có muốn đánh giá khách hàng này ?", function () {
        processingDlg.show();
        Xrm.Page.data.save().then(function () {
            RunWorkflow("4632DB4C-8FCE-4339-94B7-0142A4445754", Xrm.Page.data.entity.getId(), function (req) {
                if (req.readyState == 4) {
                    processingDlg.hide();
                    if (req.status == 200) {
